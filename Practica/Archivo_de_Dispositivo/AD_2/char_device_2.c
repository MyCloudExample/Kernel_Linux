/* 
 * Este ejemplo utiliza el esqueleto es decie crea el archivo char device, pero ademas se adiciona la funcionalidad de lectura
 * y escritura. Este modulo es un dirver que toma lo ingresado por teclado y lo guarda para que el modulo lo muestre por 
 * consola.
*/
/*===========================HEADERS=============================================================================================*/
...
dev_t chrdev_number; //VARIABLE QUE GUARDA LOS MAJOR I MINOR NUMBERS DEL CHAR DEVICE
struct class *chrdev_class; //CLASE DEL CAHR DEVICE
struct chrdev_data *chrdev_data; //PUNTERO A LOS DATOS DEL DISPOSITIVO
/*===========================PROTOTIPO DE FUNCIONES QUE SE ADICIONAN=============================================================*/
